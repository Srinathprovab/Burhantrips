...
class SendUsMessageTVCell: TableViewCell, UITextViewDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: namelbl, text: "Name", textcolor: HexColor("#10002E"), font: .PoppinsRegular(size: 12), align: .left)
        setuplabels(lbl: emaillbl, text: "Email", textcolor: HexColor("#10002E"), font: .PoppinsRegular(size: 12), align: .left)
        setuplabels(lbl: phonelbl, text: "Phone", textcolor: HexColor("#10002E"), font: .PoppinsRegular(size: 12), align: .left)
        setuplabels(lbl: countryCodelbl, text: "Country Code", textcolor: HexColor("#10002E"), font: .PoppinsRegular(size: 12), align: .left)
        setuplabels(lbl: submitBtnlbl, text: "Submit", textcolor: .WhiteColor, font: .PoppinsMedium(size: 14), align: .center)
        setuplabels(lbl: messagelbl, text: "Message", textcolor: HexColor("#10002E"), font: .PoppinsRegular(size: 12), align: .left)
...
extension UITextView{
    ...
    func setPlaceholder(ph:String) {
        ...
        placeholderLabel.font = UIFont.PoppinsRegular(size: 14)
