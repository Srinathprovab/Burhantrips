...
class AddDeatilsOfTravellerTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: titlelbl, text: "", textcolor: .AppBtnColor, font: .InterMedium(size: 14), align: .left)
//        dropdownimg.image = UIImage(named: "down")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppLabelColor)
        
        contentView.backgroundColor = UIColor.AppHolderViewColor
        holderView.layer.borderColor = UIColor.AppGreenColor.cgColor
...
extension AddDeatilsOfTravellerTVCell {
    ...
    func setAttributedText(str1:String,str2:String)  {
        ...
        let atter1 = [NSAttributedString.Key.foregroundColor:UIColor.AppBtnColor,NSAttributedString.Key.font:UIFont.InterMedium(size: 14)] as [NSAttributedString.Key : Any]
        let atter2 = [NSAttributedString.Key.foregroundColor:HexColor("#616161"),NSAttributedString.Key.font:UIFont.InterRegular(size: 10)] as [NSAttributedString.Key : Any]
