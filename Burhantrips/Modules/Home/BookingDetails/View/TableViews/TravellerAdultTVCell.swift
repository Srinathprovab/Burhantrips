...
class TravellerAdultTVCell: UITableViewCell {
    ...
    func setupUI() {
        ...
        setupLabels(lbl: adultCountlbl, text: "traveller 1( adult)", textcolor: HexColor("#565656"), font: .PoppinsRegular(size: 14))
        setupLabels(lbl: farelbl, text: "Fare", textcolor: HexColor("#565656"), font: .PoppinsRegular(size: 16))
        setupLabels(lbl: taxeslbl, text: "Taxes and Fees", textcolor: HexColor("#565656"), font: .PoppinsRegular(size: 14))
