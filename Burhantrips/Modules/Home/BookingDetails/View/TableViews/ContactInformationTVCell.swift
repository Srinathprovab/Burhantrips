...
class ContactInformationTVCell: TableViewCell {
    ...
    override func updateUI() {
        self.countrycodeTF.text = defaults.string(forKey: UserDefaultsKeys.countryCode) ?? "0"
    ...
    func setupUI() {
        ...
        setupLabels(lbl: titlelbl, text: "Address", textcolor: .AppLabelColor, font: .InterMedium(size: 16))
