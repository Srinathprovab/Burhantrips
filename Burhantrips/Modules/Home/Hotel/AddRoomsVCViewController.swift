...
class AddRoomsVCViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, RoomsCountTVCellDelegate, ButtonTVCellDelegate {
    ...
    func setupUI() {
        closeBtn.layer.cornerRadius = closeBtn.layer.frame.width / 2
        self.view.backgroundColor = .black.withAlphaComponent(0.4)
        setuplabels(lbl: titlelbl, text: "Guests & Add Rooms", textcolor: .AppLabelColor, font: .PoppinsRegular(size: 16), align: .center)
        ...
        tv.register(UINib(nibName: "LongEmptyTVCell", bundle: nil), forCellReuseIdentifier: "cell2")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            if let cell = tableView.dequeueReusableCell(withIdentifier: "cell2") as? LongEmptyTVCell {
                ccell = cell
            }
        } else {
            if let cell = tableView.dequeueReusableCell(withIdentifier: "cell1") as? ButtonTVCell {
                ...
                cell.titlelbl.font = .InterSemiBold(size: 18)
                cell.btnView.backgroundColor = .AppBtnColor
                ccell = cell
            }
        }
        return ccell
