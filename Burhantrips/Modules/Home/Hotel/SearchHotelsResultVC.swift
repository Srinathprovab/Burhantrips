...
class SearchHotelsResultVC: BaseTableVC, UITextFieldDelegate, HotelSearchViewModelDelegate {
    ...
    @IBOutlet weak var clickBackLabel: UILabel!
...
//        cvHolderView.backgroundColor = .AppHolderViewColor
        cvHolderView.addBottomBorderWithColor(color: .AppBorderColor, width: 1)
        recommandedbtn.setTitle("", for: .normal)
        setuplabels(lbl: recommandedlbl, text: "SORT", textcolor: .AppLabelColor, font: .InterRegular(size: 16), align: .center)
...
//        callapibool = true
    ...
    func setAttributedText1(str1:String,str2:String,lbl:UILabel)  {
        ...
        let atter1 = [NSAttributedString.Key.foregroundColor:UIColor.AppLabelColor,
                      NSAttributedString.Key.font:UIFont.InterRegular(size: 12)] as [NSAttributedString.Key : Any]
        let atter2 = [NSAttributedString.Key.foregroundColor:UIColor.AppLabelColor,
