...
struct TopFlightDetailsModel : Codable {
    ...
    let holiday_top_destination : [city_data_list]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case holiday_top_destination = "city_data_list"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        holiday_top_destination = try values.decodeIfPresent([city_data_list].self, forKey: .holiday_top_destination)
    }
