...
//          filterKey = "sort"
        ...
        resetBtn.titleLabel?.font = UIFont.InterRegular(size: 14)
    ...
    override func didTapOnLowtoHighBtn(cell: SortbyTVCell) {
        ...
        cell.lowtoHighView.backgroundColor = .AppYellowColor
    ...
    override func didTapOnHightoLowBtn(cell: SortbyTVCell) {
        ...
        cell.hightoLowhlbl.textColor = .AppLabelColor
        cell.hightoLowView.backgroundColor = .AppYellowColor
