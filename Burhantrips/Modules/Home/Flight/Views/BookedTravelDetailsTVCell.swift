...
class BookedTravelDetailsTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: travellerNamelbl, text: "Name", textcolor: .AppLabelColor, font: .InterMedium(size: 14), align: .center)
        setuplabels(lbl: typelbl, text: "Ticket No", textcolor: .AppLabelColor, font: .InterMedium(size: 14), align: .center)
        setuplabels(lbl: seatlbl, text: "Status", textcolor: .AppLabelColor, font: .InterMedium(size: 14), align: .center)
        ...
        if let selectedTap = defaults.object(forKey: UserDefaultsKeys.dashboardTapSelected) as? String {
            ...
            if selectedTap == "Flights" {
                ...
                if let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? BookedAdultDetailsTVCell {
                    ...
                    cell.seatlbl.text = data.ticket_no ?? ""
                    if indexPath.row == 0{
