...
//        holderView.backgroundColor = .WhiteColor
        ...
        setuplabels(lbl: fromCityShortlbl, text: "dubai (dXB)", textcolor: .AppLabelColor, font: .InterRegular(size: 12), align: .center)
        setuplabels(lbl: totimelbl, text: "07:50", textcolor: .AppLabelColor, font: .InterSemiBold(size: 18), align: .right)
        setuplabels(lbl: toCityShortlbl, text: "kuwait (KWI)", textcolor: .AppLabelColor, font: .InterRegular(size: 12), align: .center)
