...
class BookFlightDetailsTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        holderView.addCornerRadiusWithShadow(color: .clear, borderColor: .AppGreenColor, cornerRadius: 8)
        setuplabels(lbl: refundlbl, text: "", textcolor: HexColor("#288419"), font: .InterMedium(size: 12), align: .right)
        viewFlightDetailsBtnView.backgroundColor = .AppGreenColor
        viewFlightDetailsBtnView.addCornerRadiusWithShadow(color: .clear, borderColor: .clear, cornerRadius: 5)
        setuplabels(lbl: viewFlifgtDetailslbl, text: "Flight Details", textcolor: .WhiteColor, font: .InterRegular(size: 12), align: .center)
