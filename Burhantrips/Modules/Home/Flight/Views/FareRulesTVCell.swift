...
class FareRulesTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: titlelbl, text: "Cancellation fees", textcolor: .AppLabelColor, font: .InterMedium(size: 14), align: .left)
        setuplabels(lbl: subTitlelbl, text: "", textcolor: .AppLabelColor, font: .InterRegular(size: 12), align: .left)
        
        dropDownImg.image = UIImage(named: "down")
