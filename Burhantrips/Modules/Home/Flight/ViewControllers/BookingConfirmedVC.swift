...
extension BookingConfirmedVC {
    ...
    func setupTV() {
        ...
        tablerow.append(TableRow(title:"Thank you for booking with Bhuran Your attraction voucher has been shared on the confirmed email.",key: "booked",cellType:.LabelTVCell))
